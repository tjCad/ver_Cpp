...
static struct feature* get_match( struct feature*, int );
...
static  void release_mem( CvPoint2D64f*, CvPoint2D64f*,
				struct feature** );
...
*/
static  struct feature* get_match( struct feature* feat, int mtype )
{
...
*/
static  void release_mem( CvPoint2D64f* pts1, CvPoint2D64f* pts2,
